...
const builtInInsights: Article[] = [
  ...
  {
    "slug": "the-effects-of-climate-change-are-increasingly-visible-in-ireland",
  ...
  {
    "slug": "apartment-duplex-defects-remediation-bill-2024",
  ...
  {
    "slug": "healthy-homes-ireland-retrofit",
    ...
    "body": [
      ...
      "Kevin O’Rourke, Chair of Healthy Homes Ireland, echoed these sentiments, call ing for immediate governmental action. He stated, “Our research, including the ‘Towards Healthier Greener Homes’ report, clearly shows the profound impact of housing quality on well-being. We need swift and decisive action to ensure that everyone in Ireland can live in a healthy, green home. Investing in this now will not only improve health outcomes but also reduce future healthcare costs.”"
    ]
  },
  {
    "slug": "shortlisted-for-the-irish-building-and-design-awards-recognised-as-being-best-in-class",
    ...
    "body": [
      ...
      "We now eagerly anticipate the revelation of the project’s outcome at the imminent Irish Building & Design Awards. [/av_textblock]",
      "[av_gallery ids=’2023,2017,2022,2021,2020,2019′ style=’thumbnails’ preview_size=’portfolio’ crop_big_preview_thumbnail=’avia-gallery-big-crop-thumb’ thumb_size=’portfolio’ columns=’5′ thumbs_hover=” control_layout=’av-control-hidden’ slider_navigation=’av-navigate-arrows’ nav_visibility_desktop=” nav_arrow_color=” nav_arrow_bg_color=” imagelink=’lightbox’ link_dest=” lightbox_text=’caption’ lazyload=’avia_lazyload’ img_scrset=” html_lazy_loading=’disabled’ alb_description=” id=” custom_class=” template_class=” av_uid=’av-1u2q9q’ sc_version=’1.0′ admin_preview_bg=”]"
    ]
  },
  {
    "slug": "government-announces-interim-fire-safety-funding-for-celtic-tiger-era-apartments",
  ...
  {
    "slug": "legislative-hurdles-delay-remediation-apartment-defects-2024",
  ...
  {
    "slug": "the-urgent-need-for-modular-housing-to-address-the-crisis-in-ireland",
  ...
  {
    "slug": "celtic-tiger-apartment-defects-repair-plan",
  ...
  {
    "slug": "embracing-a-sustainable-cladding-alternative",
  ...
  {
    "slug": "a-breakthrough-in-solar-power-with-chromium",
  ...
  {
    "slug": "zero-emission-concrete-on-the-horizon-as-industry-standard",
    ...
    "body": [
      ...
      "Traditional cement production has long been synonymous with high carbon emissions due to the energy-intensive process of converting limestone into Portland cement. However, the tide is turning with recent breakthroughs in sustainable technology. One such milestone was the world’s first zero emissions industrial trial for Portland cement, launched in the UK . This landmark initiative signifies a turning point, demonstrating that a cement production process with net-zero emissions is indeed achievable.",
      "The heart of this innovation lies in carbon capture technology and the utilization of alternative raw materials. These advancements mitigate emissions by capturing carbon dioxide emitted during the cement manufacturing process and incorporating it back into the concrete mixture, thereby creating a circular and sustainable material cycle. This breakthrough heralds a new era of environmentally conscious construction materials.",
      "The process of producing zero emission concrete is multifaceted and revolutionary. It encompasses:",
      "1. Carbon Capture: Advanced carbon capture techniques are employed during cement production to capture carbon dioxide emissions before they are released into the atmosphere. This captured CO2 is then utilized in the concrete mixture.",
      "2. Alternative Raw Materials: Traditional raw materials are partially replaced with innovative substitutes, such as fly ash, slag, and calcined clay. These materials not only lower emissions but also reduce the reliance on finite resources like limestone."
    ]
  },
  {
    "slug": "retrofitting-buildings-for-a-sustainable-future",
  ...
  {
    "slug": "aoca-team-spreads-joy-through-community-service-at-lauralynn-hospice",
  ...
  {
    "slug": "defective-block-works-crisis-tackled-by-aoca",
  ...
  {
    "slug": "an-overview-of-the-enhanced-defective-concrete-blocks-grant-scheme",
  ...
  {
    "slug": "when-to-worry-about-cracks-in-home",
  ...
  {
    "slug": "why-structural-condition-survey-is-necessary",
